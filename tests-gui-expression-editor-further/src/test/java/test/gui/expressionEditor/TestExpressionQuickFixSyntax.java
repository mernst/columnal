...
public class TestExpressionQuickFixSyntax extends BaseTestQuickFix
{
    ...
    // Not sure this is a fix worth suggesting when there is only one argument
    ...
    // Disabled since move to @table references
    ...
    // TODO re-enable this and get it passing
    ...
    // Not sure if this fix is even worth implementing
